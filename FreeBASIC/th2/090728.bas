...
dim as integer sw, sh, x, y, snkcou, x1, y1, ful, cycle, wlk, spcbf, score
...
do
    ...
    locate 1,1
    print char.hlt, char.lf, char.hur
    screenunlock
    ...
    if char.sx > 0 then 
        select case colmap(int((char.x+16)/16),int(char.y/16))
        case 1:char.sx=0:char.x=int(char.x/16)*16
        case 6:colmap(int((char.x+16)/16),int(char.y/16))=0:if char.hlt=10 then:char.lf+=1:else char.hlt+=1:endif
        case 7:colmap(int((char.x+16)/16),int(char.y/16))=0:score+=10
        end select
        select case colmap(int((char.x+16)/16),int((char.y+16)/16))
        case 1:char.sx=0:char.x=int(char.x/16)*16
        case 6:colmap(int((char.x+16)/16),int((char.y+16)/16))=0:if char.hlt=10 then:char.lf+=1:else char.hlt+=1:endif
        case 7:colmap(int((char.x+16)/16),int((char.y+16)/16))=0:score+=10
        end select
    endif
    if char.sx < 0 then
        select case colmap(int(char.x/16),int(char.y/16))
        case 1:char.sx=0:char.x=int(char.x/16+1)*16
        case 6:colmap(int(char.x/16),int(char.y/16))=0:if char.hlt=10 then:char.lf+=1:else char.hlt+=1:endif
        case 7:colmap(int(char.x/16),int(char.y/16))=0:score+=10
        end select
        select case colmap(int(char.x/16),int((char.y+16)/16))
        case 1:char.sx=0:char.x=int(char.x/16+1)*16
        case 6:colmap(int(char.x/16),int((char.y+16)/16))=0:if char.hlt=10 then:char.lf+=1:else char.hlt+=1:endif
        case 7:colmap(int(char.x/16),int((char.y+16)/16))=0:score+=10
        end select
    endif
